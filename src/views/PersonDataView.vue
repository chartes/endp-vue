<template>
  ...
  <div class="slider-container container">
    <div class="columns">
      <div class="column is-8">
         <p class="label-person">{{ meta_person['pref_label'] }}<span v-if="meta_person['is_canon']"> ~ Chanoine </span>
  </p>
  <br>
  <hr class="sep-3"/>
      ...
      <li v-for="link in kb_urls" :key="link">
        ...
        <div class="container" v-if="link['type'] === 'Studium Parisiense'">
          ...
          <button class="button is-dark" @click="toggleDropdown">
            <span style="font-size: 20px">Bibliographie (Studium Parisiense)</span><span class="chevron"
                                                                                         v-bind:class="{ up: showDropdown }"></span>
          </button>
          ...
          <div v-if="showDropdown" class="box content">
            <div v-if="jsonResponse && jsonResponse.bibliography">
              ...
              <div v-if="jsonResponse.bibliography.workSources">
                ...
                <hr>
                <ul>
                  <li v-for="(source, index) in jsonResponse.bibliography.workSources" :key="index">{{
                      source.value
                    }}
                  </li>
                </ul>
              ...
              <div v-if="jsonResponse.bibliography.workReferences">
                ...
                <hr>
                <ul>
                  <li v-for="(ref, index) in jsonResponse.bibliography.workReferences" :key="index">{{
                      ref.value
                    }}
                  </li>
                </ul>
              ...
              <div v-if="jsonResponse.bibliography.bookReferences">
                ...
                <hr>
                <ul>
                  <li v-for="(book, index) in jsonResponse.bibliography.bookReferences" :key="index">{{
                      book.value
                    }}
                  </li>
                </ul>
  ...
  <div>
    ...
    <br>
    <Carousel :itemsToShow="collecta_urls.length < 3 ? collecta_urls.length : 3" :wrapAround="true"
              :transition="500">
